...
$caminho = '../../../painel/images/arquivos/' .$nome_img;
...
if($cliente != "0"){
	...
	$query = $pdo->prepare("INSERT INTO $tabela SET nome = :nome,  data_cad = curDate(), usuario = '$id_usuario', arquivo = '$foto', registro = 'Paciente', id_reg = '$cliente'");
...
if($convenio != "0"){
	...
	$query = $pdo->prepare("INSERT INTO $tabela SET nome = :nome,  data_cad = curDate(), usuario = '$id_usuario', arquivo = '$foto', registro = 'Convênio', id_reg = '$convenio'");
