...
if($linhas == 0){
	...
	$pdo->query("INSERT INTO config SET nome = '$nome_sistema', email = '$email_sistema', telefone = '$telefone_sistema', logo = 'logo.png', logo_rel = 'logo.jpg', icone = 'icone.png', marca_dagua = 'Sim', ativo = 'Sim', paciente_receita = 'Sim', ocultar_acessos = 'Sim', desativar_marketing = 'Sim'");
...
$desativar_marketing = $res[0]['desativar_marketing'];
