					...
					<div class="row">
						...
						<label>Ocultar Acessos</label>	
							...
							<select class="form-control" name="ocultar_acessos">
								...
								<option value="Sim" <?php if($ocultar_acessos == 'Sim'){ echo 'selected'; } ?>>Sim</option>

								<option value="Não" <?php if($ocultar_acessos == 'Não'){ echo 'selected'; } ?>>Não</option>
						...
						<label>Desativar Marketing</label>	
							...
							<select class="form-control" name="desativar_marketing">
								...
								<option value="Sim" <?php if($desativar_marketing == 'Sim'){ echo 'selected'; } ?>>Sim</option>

								<option value="Não" <?php if($desativar_marketing == 'Não'){ echo 'selected'; } ?>>Não</option>
		...
		<div class="modal-content">
			...
			<div class="row">				
				...
				<div class="col-md-4">
					...
					<select name="procedimento" class="form-control sel170" style="width:100%">
