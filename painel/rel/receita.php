		...
		<table id="" style="border-style: solid; font-size: 9px; margin-bottom:10px; width: 100%; table-layout: fixed; margin-top:10px;">
			...
			<thead>
    			...
    			<tr >
					...
					<td style="width:10%; border-right: 1px solid #000;border-bottom: : 1px solid #000;">SEXO: </td>

					<td style="width:35%; border-right: : 1px solid #000; border-bottom: : 1px solid #000;">

						<?php echo mb_strtoupper($sexoF) ?>

					</td>

					

					<td style="width:15%; border-right: 1px solid #000; border-bottom: : 1px solid #000;">DATA NASCIMENTO: </td>
    			...
    			<tr >
					...
					<td style="width:10%; border-right: 1px solid #000;border-bottom: : 1px solid #000;">CONVÊNIO: </td>

					<td style="width:35%; border-right: : 1px solid #000; border-bottom: : 1px solid #000;">

						<?php echo mb_strtoupper($convenio) ?>

					</td>

					

					<td style="width:15%; border-right: 1px solid #000; border-bottom: : 1px solid #000;">ESTADO CÍVIL: </td>
...
$crm_medico = @$res2[0]['crm'];
if($crm_medico != ""){
	$crm_medicoF = ' / CRM: '.$crm_medico;
}else{
	$crm_medicoF = '';
}
...
<hr style="margin:2px; border:1px solid #dbdbdb">
...
<?php 
 ...
 <div style="margin-top: 150px; font-size:13px" align="center">
 	...
 	<br>Dr <?php echo $nome_medico ?> <?php echo $crm_medicoF ?>
