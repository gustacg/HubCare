...
<div class="modal fade" id="modalReceita" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static">
			...
			<div class="modal-body">
				...
				<div class="row">
						...
						<div class="col-md-1" style="margin-top: 22px; margin-left: -10px">
							<button id="btn_remedios" type="button" data-toggle="modal" data-target="#modalRemedios" class="btn btn-primary"> <i class="fa fa-plus"></i> </button>		
			...
			<div class="modal-body">
				...
				<div class="row">
						...
						<div class="col-md-5">	
								...
								<select class="sel20" id="exame" name="exame" style="width:100%" onchange="trocarExame()">
...
<div class="modal fade" id="modalRemedios" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<h4 class="modal-title" id="exampleModalLabel">Adicionar Remédio</h4>

				<button id="btn-fechar-receitas" type="button" class="close" data-dismiss="modal" aria-label="Close" style="margin-top: -25px">
			...
			<div class="modal-body">
					...
					<div class="row">
						...
						<div class="col-md-5">							
								...
								<input type="text" class="form-control" id="quantidade_rec" name="quantidade" placeholder="1 Frasco, 10 Comprimidos, etc" >							
					...
					<div class="row">
						...
						<div class="col-md-12">						
								...
								<input maxlength="500" type="text" class="form-control" id="uso_rec" name="uso" placeholder="Tomar 1 comprimido pela manhã ...">							
			...
			<div class="modal-footer">
					...
					<button id="btn_salvar_receitas" type="submit" class="btn btn-primary">Salvar</button>
...
<script>
	...
	$("#form-receitas").submit(function () {

		$('#mensagem_receitas').text('Carregando...');

		$('#btn_salvar_receitas').hide();
		...
		$.ajax({
			...
			url: 'paginas/receitas/salvar.php',
			...
			success: function (mensagem) {
				...
				$('#mensagem_receitas').text('');

				$('#mensagem_receitas').removeClass()

				if (mensagem.trim() == "Salvo com Sucesso") {                    

					$('#btn-fechar-receitas').click();
					...
					$('#mensagem_receitas').addClass('text-danger')

					$('#mensagem_receitas').text(mensagem)

				}



				$('#btn_salvar_receitas').show();
...
<script type="text/javascript">
	function listarReceitas(valor){
	$.ajax({
        url: 'paginas/' + pag + "/listar_receitas.php",
        method: 'POST',
        data: {valor},
        dataType: "html",

        success:function(result){
            $("#listar_receitas").html(result);           
        }
    });
}


function mudarRemedio(){				
				
				var id_remedio = $('#remedio').val();

				$.ajax({
			        url: 'paginas/' + pag + "/listar_dados_remedio.php",
			        method: 'POST',
			        data: {id_remedio},
			        dataType: "html",
