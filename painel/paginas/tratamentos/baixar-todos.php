...
$pdo->query("INSERT INTO $tabela SET descricao = '$descricao', referencia = 'Tratamento', valor = '$valor_serv', data_lanc = curDate(), data_venc = '$data_pgto', data_pgto = '$data_pgto2', usuario_lanc = '$usuario_logado', usuario_pgto = '$usuario_baixa', arquivo = 'sem-foto.png', cliente = '$cliente', pago = '$pago', id_ref = '$servico', saida = '$pgto', hora = curTime(), caixa = '$id_caixa'");

}else{

	$foi_pago = 'Sim';

	$pdo->query("INSERT INTO $tabela SET descricao = '$nome_cv', referencia = 'Convenio', valor = '$valor_pelo_cv;', data_lanc = curDate(), data_venc = curDate(), data_pgto = curDate(), usuario_lanc = '$usuario_logado', usuario_pgto = '$usuario_baixa', arquivo = 'sem-foto.png', cliente = '$cliente', pago = 'Não', id_ref = '$servico', saida = '$pgto', hora = curTime(), caixa = '$id_caixa'");
