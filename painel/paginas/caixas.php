	...
	<div class="modal-dialog" role="document">
		...
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<button id="btn-fechar_fechamento" type="button" class="close" data-dismiss="modal" aria-label="Close" style="margin-top: -25px">
	...
	<div class="modal-dialog" role="document">
		...
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<button id="btn-fechar_sangria" type="button" class="close" data-dismiss="modal" aria-label="Close" style="margin-top: -25px">
