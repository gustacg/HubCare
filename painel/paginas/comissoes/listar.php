...
if($funcionario2 != ""){
	...
	$query = $pdo->query("SELECT * FROM $tabela where data_lanc >= '$dataInicial' and data_lanc <= '$dataFinal' and pago LIKE '$status' and funcionario = '$funcionario2' and referencia = 'Comissão' ORDER BY pago asc, data_venc asc");

}else{

	$query = $pdo->query("SELECT * FROM $tabela where data_lanc >= '$dataInicial' and data_lanc <= '$dataFinal' and pago LIKE '$status' and funcionario LIKE '$funcionario' and referencia = 'Comissão' ORDER BY pago asc, data_venc asc");
