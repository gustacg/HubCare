...
$query = $pdo->query("SELECT * FROM dias where funcionario = '$funcionario' and (dia = '$dia_procurado' or data = '$data')");
		...
		//VERIFICAR NA TABELA HORARIOS AGD SE TEM O HORARIO NESSA DATA
			...
			<div class="col-md-2 <?php echo $ocultar ?>">
				...
				<div class="form-check">
					...
					<input class="form-check-input" type="radio" name="hora" value="<?php echo $hora ?>" <?php echo $checado ?> <?php echo $checado2 ?> <?php echo $checado3 ?> <?php echo $horario_marcado ?>>
