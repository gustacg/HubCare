...
$pdo->query("INSERT INTO $tabela SET descricao = '$descricao', referencia = 'Procedimento', valor = '$valor_serv', data_lanc = curDate(), data_venc = '$data_pgto', data_pgto = '$data_pgto2', usuario_lanc = '$usuario_logado', usuario_pgto = '$usuario_baixa', arquivo = 'sem-foto.png', cliente = '$cliente', pago = '$pago', id_ref = '$servico', saida = '$pgto', hora = curTime(), caixa = '$id_caixa'");
