...
<td>
	...
	<big><a href="#" onclick="editar('{$id}','{$nome}','{$telefone}','{$cpf}','{$endereco}','{$data_nasc}','{$tipo_sanguineo}','{$nome_responsavel}','{$cpf_responsavel}','{$convenio}','{$sexo}','{$obs}','{$estado_civil}','{$profissao}','{$telefone2}')" title="Editar Dados"><i class="fa fa-edit text-primary"></i></a></big>
...
<li class="dropdown head-dpdn2" style="display: inline-block;">
		...
		<a title="Redefinir Senha para 123" href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><big><i class="fa fa-lock text-danger"></i></big></a>
		...
		<p>Redefinir Senha para 123? <a href="#" onclick="redefinir('{$id}')"><span class="text-success">Sim</span></a></p>
...
<big><a href="#" onclick="mostrar('{$nome}','{$telefone}','{$endereco}','{$data_nascF}','{$tipo_sanguineo}','{$nome_responsavel}', '{$nome_convenio}', '{$sexo}','{$obs}','{$idade}','{$id}','{$profissao}','{$estado_civil}','{$cpf}','{$telefone2}')" title="Mostrar Dados"><i class="fa fa-info-circle text-primary"></i></a></big>
...
<script type="text/javascript">
	...
	function editar(id, nome, telefone, cpf, endereco, data_nasc, tipo_sanguineo, nome_responsavel, cpf_responsavel, convenio, sexo, obs, estado_civil, profissao, telefone2){
