...
<form action="rel/tratamentos_class.php" method="post" target="_blank">

		<div style="float:left; margin-right:35px">

			<a onclick="inserir2()" type="button" class="btn btn-primary"><span class="fa fa-plus"></span> Tratamento</a>
		...
		<div class="esc" style="float:left; margin-right:20px">
			...
			<select class="form-control sel50" aria-label="Default select example" name="prof" id="prof" style="width:200px" onchange="buscar()">
				...
				<div class="modal-body">
					...
					<div class="row">
						...
						<div class="col-md-4">	
							...
							<select class="form-control sel2" id="paciente" name="paciente" style="width:100%;" onchange="listar()" required> 
						...
						<div class="col-md-4">							
							...
							<select class="form-control sel2" id="profissional" name="profissional" style="width:100%;" onchange="listar(); mudarFuncionarioModal2();" required=""> 
						...
						<div class="col-md-4">							
							...
							<select class="form-control sel2" id="procedimento" name="procedimento" style="width:100%;" required> 									
					...
					<div class="row">
						...
						<div class="col-md-4">							
							...
							<select class="form-control" name="vezes" id="vezes" onchange="aparecer();">
	...
	<div class="modal-dialog modal-lg" role="document">
		...
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<h4 class="modal-title" id="titulo_inserir_editar"></h4>

				<button id="btn-fechar-5" type="button" class="close" data-dismiss="modal" aria-label="Close" style="margin-top: -20px">
		...
		<div class="modal-dialog" role="document">
			...
			<div class="modal-content">
				...
				<div class="modal-header">
					...
					<h4 class="modal-title"><span id="procedimento"></span> Baixa no Valor</h4>
