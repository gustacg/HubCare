...
if($id == ""){
	...
	$query = $pdo->prepare("INSERT INTO $tabela SET descricao = :descricao, funcionario = '$funcionario', valor = :valor, data_venc = '$data_venc', data_pgto = '$data_pag', frequencia = '$frequencia', saida = '$saida', data_lanc = curDate(), usuario_lanc = '$id_usuario', usuario_pgto = '$usuario_pgto', arquivo = '$foto', pago = '$pago', referencia = '$referencia', obs = :obs, hora = curTime(), caixa = '$id_caixa'");
