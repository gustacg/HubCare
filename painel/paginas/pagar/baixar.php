...
if($valor == $valor_antigo){
	...
	$pdo->query("UPDATE $tabela set saida = '$saida', usuario_pgto = '$id_usuario', pago = 'Sim', valor = '$subtotal', data_pgto = '$data_baixar', hora = curTime(), caixa = '$id_caixa' where id = '$id'");
	...
	if(@$dias_frequencia > 0){
		...
		$pdo->query("INSERT INTO $tabela set descricao = '$descricao', funcionario = '$cliente', valor = '$valor_antigo', data_lanc = curDate(), data_venc = '$nova_data_vencimento', frequencia = '$frequencia', saida = '$saida_antiga', arquivo = '$arquivo', pago = 'Não', referencia = '$referencia'");
	...
	$query = $pdo->query("SELECT * FROM valor_parcial WHERE id_conta = '$id' and tipo = 'Pagar'");
	...
	$pdo->query("UPDATE $tabela set saida = '$saida', usuario_pgto = '$id_usuario', valor = '$valor_antigo', data_pgto = curDate(), hora = curTime(), caixa = '$id_caixa' where id = '$id'");
