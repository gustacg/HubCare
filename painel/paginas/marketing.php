...
<br>
<p style="font-size:14px"><b>ATENÇÃO:</b> Use um número diferente do seu número principal para este recurso, pois o whatsapp pode bloquear seu número se entender que está efetuando disparos de spam!</p>
	...
	<div class="modal-dialog" role="document">
		...
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<h4 class="modal-title" id="exampleModalLabel"><span id="nome_entrada"></span> - <span id="total_pacientes"></span> Pacientes</h4>
				...
				<div class="row">
						...
						<div class="col-md-5">
							...
							<div class="form-group">
								...
								<label for="exampleInputEmail1">Pacientes</label>

								<select name="pacientes" id="pacientes" class="form-control" onchange="selecionarPacientes()">
									...
									<option value="pacientes Semana">pacientes Cadastrados Semana</option>

									<option value="pacientes Mês">pacientes Cadastrados Mês</option>
